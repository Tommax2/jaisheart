...
const Footer = () => {
  return (
    <footer
      className={`${styles.paddingX} w-full py-10 bg-primary border-t border-[#232631]`}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2">
            <img src={logo} alt="logo" className="w-9 h-9 object-contain" />
            <p className="text-white text-[18px] font-bold">Jaiscolorflow</p>
          </div>
        ...
        <div className="flex flex-col items-center md:items-end gap-4">
          <div className="flex gap-5 items-center">
            ...
            <a
              href="https://www.tommax.org"
              target="_blank"
              rel="noreferrer"
              aria-label="Developer Portfolio (opens in new tab)"
              className="inline-flex items-center gap-2 bg-transparent border border-secondary text-secondary hover:bg-white/5 hover:text-white transition-colors text-[14px] py-2 px-3 rounded-md shadow-sm"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <span className="font-medium">Tommax Developer</span>
            </a>
          </div>
